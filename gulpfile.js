...
gulp.task( 'default', ['clean', 'scss', 'js', 'img', 'video', 'html', 'watch'] );
...
gulp.task( 'html', ['clean', 'scss', 'js', 'img', 'video'], function( done ) {
...
gulp.task( 'video', ['clean'], function( done ) {
    gulp.src( paths.srcVideo )
        .pipe( gulp.dest( paths.disVideo ) )
        .on( 'end', done );
});
...
gulp.task( 'watch', function() {
    ...
    gulp.watch( paths.srcVideo, ['video', 'html'] );
